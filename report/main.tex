...
\newcommand*\Not[0]{\algorithmicnot}
\newcommand*\Implicit[1]{\State \textit{#1}}

\algrenewcommand\alglinenumber[1]{
    {\sf\footnotesize\color{gray}\ttfamily#1}}
...
\include{problem-description} % Lør

%\section{Metaheuristic description} % Søn
\include{metaheursitic-description}

\include{parameter-tuning} % Man

\include{test-results} % Man, Fre

\include{conclusion} % Fre

\pagebreak
\appendix
\include{appendix-notation}
\include{appendix-operations}
